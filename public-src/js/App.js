...
class App extends Component {
    ...
    render() {
        ...
        const {get_map_area, toggle_layer, set_chart_data, toggle_check, check_all, set_data_region, set_data_district } = this.props.MapActions;
                    ...
                    <div className="main">
                        <div className="main__map">
                            <Map
                                ...
                                set_data_region={ set_data_region }
